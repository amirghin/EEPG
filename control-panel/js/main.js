    ...
    if (buscar!=""){
        ...
        busqueda.done(function(response){
            ...
            if(object.error){
                ...
                var table = "<tr><td>Id</td><td>Nombre</td><td>Apellido</td><td>Genero</td><td>Fecha Ingreso</td><td>Fecha nacimiento</td> <td>Talla</td><td>Peso Meta</td><td>Circunferencia de la muneca</td><td class='hidden'>Antecedentes personales</td> <td class='hidden'>Padecimientos familiares</td> <td>Nombre usuario</td>  <td>Eliminar</td> <td>Modificar</td></tr> ";
                var tableValues = "";
